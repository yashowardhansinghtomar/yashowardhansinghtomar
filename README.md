...
**AI Engineer focused on RLHF, LLM evaluation, voice AI, and applied AI systems**
...
My background combines hands-on LLM evaluation work, production voice AI integration, and business-facing product experience. I care about the gap between a demo and a system that remains useful when prompts, users, data, and edge cases get messy.

## Current Focus

- LLM evaluation, RLHF workflows, pairwise response review, and rubric design
- Voice AI systems using STT, TTS, LLMs, and conversational routing
